...
// NOTE: The getUploadSignature import is REMOVED as it is no longer used.
...
// Path: PUT /api/videos/leaders/:id
router.put('/leaders/:id', protect, isAdmin, updateLeaderVideo);
// Path: DELETE /api/videos/leaders/:id
...
// Path: PUT /api/videos/products/:id
router.put('/products/:id', protect, isAdmin, updateProductVideo);
// Path: DELETE /api/videos/products/:id
