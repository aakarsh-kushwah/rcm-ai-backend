...
async function initialize() {
    try {
        ...
        // ✅ NEW YOUTUBE ASSOCIATIONS
        db.YoutubeChannel.hasMany(db.YoutubeVideo, { foreignKey: 'channelId', as: 'videos', onDelete: 'CASCADE' });
        db.YoutubeVideo.belongsTo(db.YoutubeChannel, { foreignKey: 'channelId', as: 'channel' });


        db.Sequelize = Sequelize;
        db.sequelize = sequelize;

        // Sync (Production ready: alter: false)
