...
async function runSimulation() {
    ...
    console.log(`AI: ${resp1.response}\n`);

    history.push({ role: "user", content: msg1 });
    history.push({ role: "assistant", content: resp1.response });
    ...
    console.log(`AI: ${resp2.response}\n`);

    history.push({ role: "user", content: msg2 });
    history.push({ role: "assistant", content: resp2.response });
    ...
    console.log(`AI: ${resp3.response}\n`);

    history.push({ role: "user", content: msg3 });
    history.push({ role: "assistant", content: resp3.response });
    ...
    console.log(`AI: ${resp5.response}\n`);

    history.push({ role: "user", content: msg5 });
    history.push({ role: "assistant", content: resp5.response });
